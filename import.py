...
# Create table books
db.execute("CREATE TABLE autorinnen (id SERIAL PRIMARY KEY, autorinnenname VARCHAR(100) NOT NULL, land VARCHAR(100) NOT NULL, wohnort VARCHAR(100) NOT NULL, titel VARCHAR(200) NOT NULL, eingeladen_von VARCHAR(100) NOT NULL, teilnahmejahr VARCHAR(20) NOT NULL, geburtsjahr VARCHAR(20) NOT NULL, geschlecht VARCHAR(20) NOT NULL, vorgetragen_am VARCHAR(20) NOT NULL, preis_gewonnen  VARCHAR(20) NOT NULL, wikipedia VARCHAR(20) NOT NULL, webseite VARCHAR(100) NOT NULL)")
db.commit()


# Import data from csv file
def main():
    with open('autorinnen_updated.csv', encoding='utf-8') as f:
        reader = csv.reader(f)
        next(reader)
